...
currentAccounts, fundingRequests, desiredAllocation, categoryRules = initializeObjects('../Allocation_Template.xlsx', assets_list_start_column, assets_list_end_column)
