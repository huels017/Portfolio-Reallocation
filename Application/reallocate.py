...
def reallocate_accounts(current_account_values, desired_allocation, ira_statues, max_taxed_sales):
    ...
    fixed_accounts_vs_desired_allocation(desired_category_values, current_account_values, account_rules)
    ...
    fixed_taxed_vs_desired_allocation(desired_category_values, current_account_values, account_rules)
